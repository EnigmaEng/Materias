...
<div className=' mt-20 p-4 absolute top-14 left-8 rounded-lg shadow-xl w-10/12 bg-white dark:bg-zinc-800 text-black dark:text-white m-auto'>
  <div className=' gap-10  text-lg'>
    ...
    <div className='flex flex-col  justify-center items-center gap-2 mt-5'>
      <div className='flex'>
        <img src={usuario?.url_img_usuario} alt="perfil" className='border shadow-xl  rounded-full w-24 h-24' />
         <Link to='/editarPerfil' className='absolute right-5 top-20 px-4 py-1.5 shadow-xl  h-8  flex gap-5 rounded-lg bg-red-800 '>  <AiOutlineEdit/> </Link>
      </div>
